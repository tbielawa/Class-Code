...
PCB *PCB_setup ( char *pname, int ppriority, int pclass, PCBDLL **allqueues )
{
  // Initialize the return value PCB first
  PCB *ret;

  // First let's do some sanity checks...
  if ( PCB_find(pname, allqueues) != NULL )
    {
      return NULL;
    }
...
PCB *PCB_find ( char *find, PCBDLL **loop_queues )
{
...
int PCB_remove ( PCB *proc, PCBDLL **loop_queues )
{
