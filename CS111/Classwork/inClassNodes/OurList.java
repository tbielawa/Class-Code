 ...
 * 
 * Class: Linked List, manages data nodes
 **/
...
public class OurList
{
     ...
     /**
      * add object into the list at specified index
      * @param item object being inserted
      * @param index index at which to insert index
      **/
      ...
      * @param index indicie of object being deleted from the list
      **/
     ...
     /**
      * prints the value of the objects stored in the list
      **/
